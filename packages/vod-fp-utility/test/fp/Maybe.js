...
chai.should();
const { map, prop, join, chain, compose, curry } = F;

describe('Fp: test Maybe', () => {
  it('#Maybe base flow', () => {
    Just.of(1)
      .toString()
      .should.be.equal('Just(1)');
